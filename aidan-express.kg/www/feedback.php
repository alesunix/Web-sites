<?php
    ...
    if(empty($errors)){     
        ...
        $msg_box = "<span style='color: #666;'>Спасибо за обращение, сообщение успешно отправлено! <br/> В ближайшее время мы Вам ответим!<br/></span><br/>";
    ...
    function send_mail($message){
        ...
        $mail_to = "Aidanexpress1104@gmail.com"; 
        // тема письма
