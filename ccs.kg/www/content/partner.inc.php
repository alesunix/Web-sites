...
$title = 'Наши партнеры';
$keywords = 'Партнеры';
$description = 'Партнеры Службы Специальной Связи ';
$template = 'info';
  ...
  <div class="grid__item">
    <div class="card"><img class="card__img2" src="/i/cccb.png" alt="Россия спецсвязь" oncontextmenu="return false;">
      <div class="card__content">
        ...
        <a href="https://www.cccb.ru" target="_blank"><button class="card__btn">Перейти <span>&rarr;</span></button></a>
      </div>
    </div>
  </div>
  <div class="grid__item">
    <div class="card"><img class="card__img2" src="/i/ccskaz.png" alt="Казахстан спецсвязь" oncontextmenu="return false;">
      <div class="card__content">
        ...
        <a href="https://post.kz" target="_blank"><button class="card__btn">Перейти <span>&rarr;</span></button></a>
      </div>
    </div>
  </div>
  <div class="grid__item">
    <div class="card"><img class="card__img2" src="/i/uzsss.png" alt="Узбекистан спецсвязь" oncontextmenu="return false;">
      <div class="card__content">
        ...
        <a href="http://www.rmab.uz/index.php/ru/" target="_blank"><button class="card__btn">Перейти <span>&rarr;</span></button></a>
      </div>
    </div>
  </div>
  <div class="grid__item">
    <div class="card"><img class="card__img2" src="/i/belccs.png" alt="Беларусь спецсвязь" oncontextmenu="return false;">
      <div class="card__content">
        ...
        <a href="http://www.specsvyaz.by/" target="_blank"><button class="card__btn">Перейти <span>&rarr;</span></button></a>
      </div>
    </div>
  </div>
    <div class="grid__item">
    <div class="card"><img class="card__img2" src="/i/dpsz.png" alt="Украина спецсвязь" oncontextmenu="return false;">
      <div class="card__content">
        ...
        <a href="https://dpsz.ua/" target="_blank"><button class="card__btn">Перейти <span>&rarr;</span></button></a>
      </div>
    </div>
  </div>
</div>
