...
<center>
<h1><font style="color: #2b9fdf; text-shadow: 1px 1px 1px black;">Интерьер и территория</font></h1>
<figure class="sign00"><a href="/tarifs.html"><img src="/i/14.png" width=290" alt=""><figcaption>Апартаменты</figcaption></figure></a>
<figure class="sign00"><a href="/tarifs.html"><img src="/i/7.png"  width=290" alt=""><figcaption>Двор</figcaption></figure></a>
<figure class="sign00"><a href="/tarifs.html"><img src="/i/10.png" width=290" alt=""><figcaption>Кухня</figcaption></figure></a>
</center>
<hr>
<center>
