...
# Общие настройки
$config							= array();
$config['sitelink']				= 'https://jvk.kg/'; # URL сайта, со слэшем на конце
...
# Настройки доступа
$config['login']				= 'jvkkg'; # Логин админа
$config['password']				= 'y2Irx8@8'; # Пароль админа
...
$config['email']['receiver']			= 'jabadsuukanal@gmail.com'; # E-mail адрес, на который отправляется сообщение
