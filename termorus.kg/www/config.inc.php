...
# Общие настройки
$config							= array();
$config['sitelink']				= 'https://termorus.kg/'; # URL сайта, со слэшем на конце
$config['sitename']				= 'Termorus'; # Заголовок сайта
$config['slogan']				= '<a href="/index.html"><img src="/i/logo.png" alt="Termorus" style="height:100px;"></a>
									Слоган &thinsp;'; # Слоган
...
$config['email']['receiver']			= 'aidan-express@mail.ru'; # E-mail адрес, на который отправляется сообщение
